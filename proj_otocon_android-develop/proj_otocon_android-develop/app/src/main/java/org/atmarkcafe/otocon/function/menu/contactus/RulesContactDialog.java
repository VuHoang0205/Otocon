...
public class RulesContactDialog extends Dialog {

    public RulesContactDialog(@NonNull Context context) {
        super(context, R.style.AppTheme_Dialog);
        setCancelable(false);
        init();
    }

    public RulesContactDialog(@NonNull Context context, int themeResId) {
        super(context, R.style.AppTheme_Dialog);
        setCancelable(false);
        init();
    }
    ...
    private void init() {
        ...
        binding.title.setText(R.string.contact_us_term_title);

        //Setting webview
        WebView webView = binding.webViewRules;
        webView.getSettings().setJavaScriptEnabled(true);
        webView.setVerticalScrollBarEnabled(false);
        webView.loadUrl(BuildConfig.LINK_RULES_CONTACT);
